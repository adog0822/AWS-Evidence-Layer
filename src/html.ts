...
$('gideonOpen').addEventListener('click', () => {
  ...
  else { $('gideonBody').innerHTML = '<div class="msg bot">Hi — I\\'m Gideon. Open a control to get auto-generated remediation suggestions, or ask me anything about your scan.</div>'; }
});
