...
Parameters:
  ExternalId:
    ...
    AllowedPattern: '^loxe-[a-fA-F0-9]{24}$'
    ConstraintDescription: ExternalId must be a Loxe-generated value beginning with loxe- followed by 24 hex characters.
...
Resources:
  LoxeReadOnlyRole:
    ...
    Properties:
      ...
      Policies:
        - PolicyName: LoxeExplicitSensitiveDataDeny
          PolicyDocument:
            Version: '2012-10-17'
            Statement:
              ...
              - Sid: DenyApplicationDataReads
                ...
                Action:
                  ...
                  - 'sqs:ReceiveMessage'
                Resource: '*'
              - Sid: DenyCodeAndArtifactRetrieval
                Effect: Deny
                Action:
                  - 'lambda:GetFunction'
